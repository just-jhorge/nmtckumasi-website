    ...
    <>
      ...
      <div className="relative bg-white z-20 center flex-col">
        <section className="w-full h-full py-10 bg-slate-100 center">
          <div className="w-full md:w-[75rem] h-auto md:h-[15rem] grid grid-cols-1 md:grid-cols-3 gap-5 px-5 md:px-0 *:bg-white *:shadow-md *:p-8 *:flex *:flex-col *:justify-center">
            <div className="space-y-2">
              <h3 className="text-emerald-600 font-light text-xl md:text-2xl">
                01.
              </h3>
        ...
        <section className="w-full p-5 md:p-20 center bg-neutral-100">
