        ...
        <div className="max-w-lg space-y-5">
          ...
          <div className="text-sm md:text-base">
            <p className="mb-3">
              ...
              facilities and services to our valued users. The Library provides
              scholarly information resources, learning spaces and facilities as
              well as information to support the mission of the College. The
              Library is therefore developing resources, facilities and services
              that are geared towards the achievement of academic excellence and
              research goals of the Kumasi Nursing and Midwifery Training
              College. Our enthusiastic staff are ready to assist.
            </p>
