...
const EventCard = ({ event }: EventCardProps) => {
  ...
  return (
    <Card
      key={event.id}
      className="overflow-hidden rounded-md text-sm md:text-base shadow-sm flex flex-row md:flex-col h-full border-primary"
    >
      ...
      <CardFooter>
        ...
        >
          ...
          <DialogContent className="no-scrollbar sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
            <DialogHeader>
