      ...
      <div className="w-full container flex-between flex-col md:flex-row gap-10 md:gap-0">
        <div className="w-full">
          <div className="flex items-center gap-1">
            <Image src={schoolLogoLarge} alt="logo" height={130} width={130} />
        ...
        <div className="w-full bg-emerald-50/80 rounded-lg shadow-md px-5 md:px-14 py-10 md:py-14">
          ...
          <div className="w-full">
            <form className="w-full">
              ...
              <Button type="submit" className="flex items-center text-sm">
                Send message
              </Button>
            </form>
          </div>
